...
exports.up = function (knex) {
    return knex.schema.createTable('agent_properties', function (table) {
        table.increments();
        table.integer('iamp_agency_id');
        table.integer('iamp_branch_id');
...
exports.down = function (knex) {
    return knex.schema.withSchema('db').dropTableIfExists('agent_properties');
};
